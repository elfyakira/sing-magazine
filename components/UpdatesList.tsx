      ...
      <ul className="space-y-6" role="list">
        {updates.map((update, index) => (
          <li
            ...
            className="flex items-start gap-4 pb-6 border-b border-gray-200 last:border-b-0 transition-all duration-300 hover:bg-gray-50 hover:px-4 hover:-mx-4 rounded-sm"
          >
